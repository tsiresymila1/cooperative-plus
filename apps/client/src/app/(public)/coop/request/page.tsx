            ...
            <div className="mx-auto max-w-[720px]">
              <div className="mb-10">
                ...
                <p className="mt-4 max-w-[560px] font-body text-[16px] leading-[26px] text-navy/70">
                  Remplissez le formulaire. Après validation par notre équipe,
                  vous recevrez vos accès pour gérer routes, véhicules, horaires
                  et réservations.
                </p>
              </div>
