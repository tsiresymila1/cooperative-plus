...
export default function BookingForm({
  ...
  return (
    <form
      className={cn(
        `relative grid w-full grid-cols-1 md:grid-cols-2 gap-px bg-white lg:grid-cols-[289fr_299fr_284fr_283fr_228px]`, className
      )}
      onSubmit={(e) => {
        e.preventDefault();
        ...
        const pax =
          String(fd.get("passengers") || "1").replace(/\D/g, "") || "1";
