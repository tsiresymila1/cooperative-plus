...
const FEATURES = [
  {
    ...
    body: "Tous les taxis-brousse et coopératives, en un seul endroit.",
  },
  {
    Icon: Armchair,
    title: "Choisissez votre siège",
    body: "Visualisez le véhicule et réservez la place exacte.",
  },
  {
    Icon: CreditCard,
    title: "Paiement simple",
    body: "Mobile Money ou à bord, selon la coopérative.",
  },
  {
    Icon: ShieldCheck,
    title: "Billet électronique",
    body: "QR code sécurisé, présenté au chauffeur.",
  },
];
  ...
  async function testNotif() {
    ...
    setTestMsg(
      ok
        ...
        : "Indisponible (nécessite un build, pas Expo Go)",
    );
        ...
        >
          ...
          <Card className="px-4 py-1">
            <ContactRow
              Icon={Globe}
              label="Site web"
              value="cooperativeplus.mg"
              onPress={() =>
                Linking.openURL("https://cooperativeplus.vercel.app").catch(
                  () => {},
                )
              }
            />
            ...
            <ContactRow
              Icon={Mail}
              label="Email"
              value="tsiresymila@gmail.com"
              onPress={() =>
                Linking.openURL("mailto:tsiresymila@gmail.com").catch(() => {})
              }
            />
            <View className="h-px bg-ink/8" />
            <ContactRow
              Icon={Phone}
              label="Téléphone"
              value="+261 34 20 835 74"
              onPress={() =>
                Linking.openURL("tel:+261342083574").catch(() => {})
              }
            />
            <View className="h-px bg-ink/8" />
            <ContactRow
